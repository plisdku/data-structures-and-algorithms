...
Ok, with a little help from Monsieur Copilot, I got a fancy benchmark going which
 - runs my four functions on varying sizes of inputs
 - plots runtime versus input size
