...
#[allow(dead_code)]
pub fn generate_random_integers(n: usize, min: i32, max: i32) -> Vec<i32> {
...
pub fn max_sub_sum_cubic(array: &[i32]) -> i32 {
...
#[allow(dead_code)]
pub fn max_sub_sum_quadratic(array: &[i32]) -> i32 {
    let mut max_sum: i32 = 0;
...
pub fn max_sub_sum_nlogn(array: &[i32]) -> i32 {
    if array.is_empty() {
        0
    } else if array.len() == 1 {
        array[0]
...
#[allow(dead_code)]
pub fn max_sub_sum_linear(array: &[i32]) -> i32 {
